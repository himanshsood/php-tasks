<?php include_once(__DIR__ . '/header.php'); ?>
    ...
    <!-- Heading -->
    <div id="home-section" class="container mt-5 mb-5 text-center">
        <h1>Welcome to Oriental Outsourcing Consultants Private Limited</h1>
    </div>

    <!-- About Section -->
    <section id="about-section" class="container mt-4">
        <div class="row">
            <div class="col-md-3">
                <img src="https://orientaloutsourcing.com/wp-content/uploads/2024/01/20YEARS1.png" alt="About Us Image" class="img-thumbnail about-image w-100">
            </div>
            <div class="col-md-9">
                <h2>About Us</h2>
                ...
                <p>As a technology pioneer, Oriental Outsourcing possesses extensive knowledge and expertise in web development, app development, UI/UX design, and website maintenance. We are committed to assisting companies in conquering their most intricate technological challenges and driving their business growth.</p>
            </div>
        </div>
    </section>

    <!-- Services Section -->
    <section id="services-section" class="container mt-4">
